...
class UpdateForm(FlaskForm):
    patient_ssn = StringField("Patient SSN Id*", validators=[InputRequired(), Regexp(regex=r'^\d{9}$')], render_kw={'Placeholder': 'Patient SSN Id'})
    ...
    doa = DateField("Date of Admission", validators=[Optional()], format='%Y-%m-%d', render_kw={'readonly': True})
